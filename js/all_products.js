...
// products
    ...
    products.forEach((product) => {
      ...
      var old_price = product.old_price ? `<p class="old_price">$${product.old_price}</p>` : "";

      var discount = product.old_price ? `<span class="sale_preasnt">${Math.floor(((product.old_price - product.price) / product.old_price) * 100)} %</span>` : ""; 
